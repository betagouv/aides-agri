...
register(agri_factories.AboutPageQuoteFactory, "quote")
register(agri_factories.AboutPageQuoteFactory, "quote_2")
register(agri_factories.AboutPageQuoteFactory, "quote_3")

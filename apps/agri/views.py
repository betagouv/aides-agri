...
class AgriMixin(ContextMixin):
    ...
    def setup(self, request, *args, **kwargs):
        ...
        self.date_installation = datetime.date.fromisoformat(date_installation) if date_installation else None
        ...
        extra_context.update(
            {
                "sujets": {
                    ...
                    for sujet in Sujet.objects.filter(themes=self.theme).exclude(aide__isnull=True)
                }
            }
        )
        ...
        extra_context.update(
            {
                    ...
                    nature: [
                        {
                            ...
                            "top_detail": {
                                "tags": [
                                    {
                                        "label": aide.natures.first().nom,
                                        "extra_classes": "fr-tag--sm",
                                    }
                                    if aide.natures.exists()
                                    else {},
                                    {
                ...
                "conseillers_entreprises_card_data": {
                    "heading_tag": "h2",
                    "extra_classes": "fr-card--horizontal-half fr-border-default--red-marianne",
                    "title": "Conseillers Entreprises",
                    ...
                    "link": "#",
                    "image_url": static("agri/images/home/illustration_conseillers_entreprise.svg"),
                    "ratio_class": "fr-ratio-1x1",
                    "media_badges": [
                        {
                            "extra_classes": "fr-badge--green-emeraude",
    ...
    def get_context_data(self, **kwargs):
        ...
        if q:
            context_data.update(
                {
                    "name": "commune",
                    "hits": ZoneGeographique.objects.communes().filter(

...
@admin.register(RawDemarcheSchemaAide)
class RawDemarcheSchemaAideAdmin(AutoFieldsetsMixin, ExtraButtonsMixin, VersionAdmin):
    ...
    def integrate(self, request, object_id):
        ...
        demarche = schema_aide.create_demarche_agricole(raw_demarche)
        return redirect(

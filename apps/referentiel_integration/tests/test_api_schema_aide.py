...
from referentiel_integration.models import RawDemarcheSchemaAide
...
class TestRawDemarcheSchemaAide:
    ...
    def test_create_dispositif(self, client_api):
        ...
        assert not RawDemarcheSchemaAide.objects.exists()
        ...
        assert RawDemarcheSchemaAide.objects.count() == 1
        dispositif = RawDemarcheSchemaAide.objects.first()

...
from ..processors.web_agent import WebAgentProcessor
...
class HybridWorkflow:
    ...
    async def monitor_url(self, url: str) -> Dict[str, Any]:
        ...
        try:
            ...
            articles_list = await self.web_agent_processor.process_content(url)
            # Step 2: LLM processing
            llm_result = self.llm_processor.process_content(web_content, article_list=articles_list)

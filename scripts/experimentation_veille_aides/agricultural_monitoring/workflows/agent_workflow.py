...
from ..processors.web_agent import WebAgentStandaloneProcessor
...
class AgentWorkflow:
    ...
    def __init__(self, max_retries: Optional[int] = None, retry_delay: Optional[int] = None):
        ...
        self.web_agent_processor = WebAgentStandaloneProcessor()
    ...
    async def monitor_url(self, url: str) -> Dict[str, Any]:
        ...
        try:
            ...
            llm_result = await self.web_agent_processor.process_content(url)

...
If the vulnerability requires a code change, our team will send you the link to the Pull Request fixing the issue.
...
Si la vulnérabilité nécessite des changements dans notre base de code, notre équipe vous enverra un lien vers la Pull Request censée résoudre le problème.
